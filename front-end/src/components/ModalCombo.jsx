...
const ModalCombo = (props) => {
  ...
  useEffect(() => {
    if (show && productId) {
      axios
        .get(`${BACK_END_HOST}/product/detail/${productId}`)
        .then((res) => {
          setProduct(res.data);
          setIsLoading(false);
        })
  ...
  useEffect(() => {
    if (product) {
      quantityInCart = quantities.find(
                ...
                <div className="col-md-6 col-sm-12">
                  {productId && product ? (
                    <div className="m-2">
                      ...
                      <div>
                        Tình trạng:{" "}
                        <span style={{ color: "#ffcb03", fontWeight: "600" }}>
                          Còn hàng
                        </span>
                      </div>
                      <div
                      ...
                      {product && product.isCombo ? ( // Ensure that product is defined and is a combo
                        <>
                          <div
                            className="d-flex"
                            style={{
                        ...
                        {isInCart ? (
                          ...
                          >
                            <GrSubtractCircle
                              ...
                              onClick={() =>
                                handleSubProduct(product, quantity)
                              }
                              color="#ffcb03"
                              size={24}
                            />
                            ...
                            <GrAddCircle
                              style={{ cursor: "pointer" }}
                              onClick={() =>
                                handleAddProduct(product, quantityInCart)
                              }
                              color="#ffcb03"
                              size={24}
                            />
                          ...
                          >
                            <GrAddCircle
                              style={{ cursor: "pointer" }}
                              onClick={() =>
                                handleAddProduct(product, startQuantity)
                              }
                              color="#ffcb03"
                              size={24}
                            />
