        ...
        <div className='row d-flex p-4' style={{ backgroundColor: "#057130"}}>
            ...
            <div className='col-lg-3 col-md-6 col-sm-6 col-12 d-flex align-items-center mb-4'>
                <div className='text-white'>
                    ...
                    <p>
                        <img className='img-fluid mr-2' width={30} src={face} alt="Facebook" />
                        <img className='img-fluid mr-2' width={30} src={zalo} alt="Zalo" />
                        <img className='img-fluid mr-2' width={30} src={tele} alt="Telegram" />
                        <img className='img-fluid mr-2' width={30} src={inta} alt="Instagram" />
                        <img className='img-fluid' width={30} src={tiktok} alt="TikTok" />
                    </p>
                </div>
            </div>
        </div>
