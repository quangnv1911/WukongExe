...
function NavBar() {
  ...
  const handleSearch = (e) => {
    ...
    // Kiểm tra nếu người dùng nhấn phím Enter (key code là 13)
    if (e.key === "Enter" || e.keyCode === 13) {
      // Ngăn chặn hành động mặc định (submit form và reload trang)
      e.preventDefault();
      return;
    }

    // Nếu không phải Enter và không bắt đầu bằng dấu cách
    if (!value.startsWith(" ")) {
    ...
    <div className="row d-flex justify-content-center align-items-center h-20 py-4 sticky-top bg-white navbar-wrapper">
      ...
      <div className="col-sm-8 d-flex justify-content-end">
        ...
        >
          ...
          <Form
            className={isSmallScreen ? "w-100" : "w-50"}
